        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Image.asset(
                    ...
                    width: MediaQuery.of(context).size.width * 0.375, // Ancho de la imagen
                    height: MediaQuery.of(context).size.width * 0.375, // Alto de la imagen
                  ),
                ),
              ),
              ...
              const Text(
                'Hola que tal, en este sistema podrás hacer control de tu casa',
                style: TextStyle(
                  color: Colors.white, // Color del texto
